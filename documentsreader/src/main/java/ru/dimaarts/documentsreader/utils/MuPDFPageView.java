...
import ru.dimaarts.documentsreader.tasks.MuPDFCancellableTaskDefinition;
...
public class MuPDFPageView extends PageView implements MuPDFView {
	...
	public void init(FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize, Bitmap sharedHqBm) {
		init(getContext(), filePickerSupport, core, parentSize, sharedHqBm);
	}
	...
	public void init(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize, Bitmap sharedHqBm) {
		super.init(c, filePickerSupport, core, parentSize, sharedHqBm);
	...
	public MuPDFPageView(Context c, FilePicker.FilePickerSupport filePickerSupport, MuPDFCore core, Point parentSize, Bitmap sharedHqBm) {
		...
		init(c, filePickerSupport, core, parentSize, sharedHqBm);
	}

	public MuPDFPageView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public MuPDFPageView(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	protected CancellableTaskDefinition<Void, Void> getDrawPageTask(final Bitmap bm, final int sizeX, final int sizeY,
		...
		return new MuPDFCancellableTaskDefinition<Void, Void>(mCore) {
			...
			public Void doInBackground(MuPDFCore.Cookie cookie, Void ... params) {
				Log.d("getDrawPageTask", "drawing entire "+mPageNumber);
				...
				Log.d("getDrawPageTask", "end drawing entire " + mPageNumber);
				return null;
			}
		};
	...
	@Override
	public void setPage(final int page, PointF size, boolean canDraw) {
		loadAnnotations();
		...
		super.setPage(page, size, canDraw);
	}
